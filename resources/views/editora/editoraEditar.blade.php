...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <h2 align = 'center'>Editar Editora</h2>
        <br>      
        <form class="container" method="post" action ="/editoraSalvarEdicao" target = "_self">
            @csrf
            <div>
                <label for="ideditora">ID:</label>
                <input type="text" class="form-control" id="ideditora" name="ideditora" readonly="true" value='{{ $editora->ideditora }}'>
            </div>
            <br>
            <div>
                <label for="nome">Nome:</label>
                <input type="text" class="form-control" id="nome" name="nome" required="true" value='{{ $editora->nome }}'>
            </div>
            <br>
